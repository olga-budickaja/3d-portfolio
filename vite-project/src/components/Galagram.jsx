...
Command: npx gltfjsx@6.1.4 galagram.gltf --transform
...
export default function Model(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/galagram-transformed.glb')
...
useGLTF.preload('/galagram-transformed.glb')
